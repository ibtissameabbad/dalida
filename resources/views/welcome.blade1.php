...
@section('content')
    ...
    <!--SliderWin -->
            ...
            <div class="container">
                ...
                <div class="row best-seller">
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <div class="image m-auto mb-2 image-fluid"></div>
                        <a class="btn w-100 p-2 p-sm-3" href="#">Achetez maintenent</a>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <div class="image m-auto mb-2"></div>
                        <a class="btn w-100 p-2 p-sm-3" href="#">Achetez maintenent</a>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <div class="image m-auto mb-2"></div>
        ...
        {{-- End Best Sellers--}}
        {{-- Start Guarantee --}}
        <section class="guarantee text-center p-5 mt-lg-5">
            <div class="container">
        ...
        {{-- end Guarantee --}}
        {{-- Start Gamme --}}
        <section class="gammes text-center mt-3">
            <div class="container wrapper">
                <div class="gamme">
                    <h1 class="d-lg-none mb-4">GAMME ANTI-ACNÉ</h1>
                    <div class="row mx-0 image-products justify-content-center">
                        <div class="col-12 col-sm-6 d-none d-sm-flex left position-relative">
                            <img src="images/gamme-mask-1.png" alt="gamme" class="img-fluid w-100">
                            <h4 class="position-absolute text py-5 bottom-0 mb-0">GAMME ANTI-ACNÉ</h4>
                        </div>
                        <div class="col-12 col-sm-6 row products p-2 p-lg-5">
                            <div class="product col-6">
                                <img src="images/gamme-product-4.png"/>
                                <h4 class="m-auto mb-1">GEL NETTOYANT</h4>
                                <div class="mb-1">
                                ...
                                <a href="#" class="btn text-white">Achetez maintenant</a>
                            </div>
                            <div class="product col-6">
                                <img src="images/gamme-product-4.png"/>
                                <h4 class="mb-1">GEL NETTOYANT</h4>
                                <div class="mb-1">
                                    <img src="images/star.svg" alt="star"/>
                                    <img src="images/star.svg" alt="star"/>
                                    <img src="images/star.svg" alt="star"/>
                ...
                <div class="row">
                    <div class="col-md-12 pl-0 pr-lg-5 d-flex flex-row gap">
                        @foreach ($products as $product)
                            <div
                                class="col-md-3 card border-0 m-2 p-2 shadow-lg d-flex flex-column bg-white rounded-xl ">
                                <span class="text-center">532 Sold out of 575</span>
                                <div class="progress mb-2" style="height:6px;">
                                    <div class="progress-bar bg-danger rounded-lg" role="progressbar" style="width:60%"
                                         aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <img class="img-fluid" src="/storage/{{ $product->image }}" alt="">
                                <span class="text-center">Get a chance to <b
                                        class="text-danger font-italic">WIN</b></span>
                                <h6 class="text-center font-weight-bold">{{ $product->name }}</h6>
                                <a href="{{ route('addToCart', [$product->id, 'type' =>'product']) }}"
                                   class="btn btn-outline-primary btn-sm rounded-xl">Add to Cart</a>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="d-flex flex-column">
                    @foreach($campaigns as $campaign)
                        <div class="camp row gap">
                            <div class="d-flex flex-fill">
                                @if ($campaign->right_label )
                                    <div class="col-md-4 bg-success mr-auto pt-2 pb-4 rounded-top-xl text-center">
                                        <span
                                            class="text-white text-center font-italic font-weight-bold">{{ $campaign->left_label }}</span>
                                    </div>
                                @endif
                                @if ($campaign->right_label )
                                    <div class="col-md-4 bg-secondary pt-2 pb-4 rounded-top-xl text-center">
                                        <span
                                            class="text-white text-center font-italic font-weight-bold">{{ $campaign->right_label }}</span>
                                    </div>
                                @endif
                            </div>
                            @if (!$campaign->right_label && !$campaign->left_label )
                                <div
                                    class="card d-flex flex-row justify-content-between border-0 shadow-lg rounded-xl p-4 mt-4">
                                    <div class="picture col-md-4 my-5">
                                        @php $sum2 = 0 @endphp
                                        @foreach ($campaign->soldes as $solde)
                                            @php $sum2 += $solde->qte @endphp
                                        @endforeach
                                        <img class="img-fluid cursor-pointer" src="/storage/{{ $campaign->image }}"
                                             alt="" data-item="{{ $campaign }}" data-solde="{{ $sum2 }}"
                                    ...
                                    <div class="infos col-md-5 d-flex flex-row">
                                        <div class="d-flex flex-column px-1 py-3">
                                            ...
                                            <span
                                                class="text-primary font-weight-bold m-top mb-2"><b>$ {{ $campaign->price }}</b></span>
                                            <div class="flex flex-row">
                                                <button
                                                    class="btn btn-outline-light rounded-xl text-dark border-secondary"
                                                    data-toggle="modal" data-target="#exampleModalCenter">See details
                                                </button>
                                                <a href="{{ route('addToCart', [$campaign->id,'type' =>'campaign']) }}"
                                                   class="btn btn-primary rounded-xl">Add to Cart</a>
                                            </div>
                                            <span
                                                class="mt-3 sm-font text-muted">Max draw date: December 25, 2021 or</span>
                                            <span class="sm-font text-muted">when the campaign is sold out. Which ever is earlier.</span>
                                        </div>
                                    </div>

                                    <div
                                        class="progressBar col-md-2 d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <span class="progress-left">
                                        ...
                                        <span class="progress-bar"></span>
                                            ...
                                            <div class="progress-value d-flex flex-column">
                                                ...
                                                <span style="border-bottom: 1px solid lightgrey;"
                                                      class="small w-75 ml-3">SOLD</span>
                                    ...
                                    <!-- Buttons-->
                                    <div
                                        class="btns col-md-1  d-flex flex-column align-items-center justify-content-center">
                                        <form method="POST"
                                              action="{{ route('addToWishlist', ['id' =>$campaign->id]) }}"
                                              enctype="multipart/form-data">
                                            @csrf
                                            <button type="submit"
                                                    class="shareBtn btn btn-outline-light border rounded-xl mb-2 border-secondary">
                                                ...
                                                @else
                                                    <svg id="darkHeart" xmlns="http://www.w3.org/2000/svg" width="20"
                                                         height="20" fill="currentColor" class="bi bi-heart text-dark"
                                                         viewBox="0 0 16 16">
                                                        <path
                                        ...
                                        <a class="shareBtn btn btn-outline-light border rounded-xl mb-2 border-secondary">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                 fill="currentColor" class="bi bi-share-fill text-dark"
                                                 viewBox="0 0 16 16">
                                                <path
                                        ...
                                        <div
                                            class="popup popuptext bg-white d-flex flex-column rounded-xl shadow-sm border-1 p-0"
                                            id="myPopup">

                                            <a id="fb"
                                               href="https://facebook.com/sharer/sharer.php?u=https://lilya.medsoft.agency/campaign/{{ $campaign->id }}"
                                               class="btn border-bottom rounded-0 d-flex flex-row justify-content-start">
                                                <i class="fab fa-facebook-f mt-1"></i>
                                                <span class="ml-2">Facebook</span>
                                            </a>
                                            <a href="https://twitter.com/share?url=https://lilya.medsoft.agency/campaign/{{ $campaign->id }}"
                                               class="btn border-bottom rounded-0 d-flex flex-row justify-content-start">
                                                <i class="fab fa-twitter mt-1"></i>
                                                <span class="ml-2">Twitter</span>
                                            </a>
                                            <a href="https://linkedin.com/shareArticle?mini=true&url=https://lilya.medsoft.agency/campaign/{{ $campaign->id }}"
                                               class="btn rounded-0 d-flex flex-row justify-content-start">
                            ...
                            @else
                                <div
                                    class="card d-flex flex-row justify-content-between border-0 shadow-lg rounded-xl p-4 m-top">
                                    <div class="picture col-md-4 my-5">
                                        @php $sum2 = 0 @endphp
                                        @foreach ($campaign->soldes as $solde)
                                            @php $sum2 += $solde->qte @endphp
                                    ...
                                    <div class="infos col-md-5 d-flex flex-row">
                                        <div class="d-flex flex-column px-1 py-3">
                                            ...
                                            <div class="flex flex-row">
                                                <button
                                                    class="btn btn-outline-light rounded-xl text-dark border-secondary"
                                                    data-item="{{ $campaign }}" data-toggle="modal"
                                                    data-target="#exampleModalCenter" id="image_show_modal">See details
                                                </button>
                                                <a href="{{ route('addToCart', [$campaign->id,'type' =>'campaign']) }}"
                                                   class="btn btn-primary rounded-xl">Add to Cart</a>
                                            </div>
                                    ...
                                    <div
                                        class="btns col-md-1  d-flex flex-column align-items-center justify-content-center">
                                        <wishlist-heart inline-template></wishlist-heart>
...
@endif
                                        ...
                                        <div
                                            ...
                                            <a href="https://facebook.com/sharer/sharer.php?u=https://lilya.medsoft.agency/campaign/{{ $campaign->id }}"
                                               class="btn border-bottom rounded-0 d-flex flex-row justify-content-start">
                                                <i class="fab fa-facebook-f mt-1"></i>
                                                <span class="ml-2">Facebook</span>
                                            </a>
            ...
            <div class="container-fluid purple rounded-xl shadow-lg py-4 pl-4 pr-5">
                ...
                <div class="row m-auto">
                    <div class="winners col-md-12 pl-0 pr-lg-5 d-flex flex-row gap">
                        @foreach ($products as $product)
                            <div
                                class="col-md-3 card m-2 py-5 px-2 border-0 shadow-lg d-flex flex-column align-items-center bg-white rounded-xl ">
                                <img class="img-fluid" src="/storage/{{ $product->image }}" alt="">
                                <h4 class="color-purple font-weight-bold text-center">Congratulations</h4>
                                <h5 class="text-center">Albert Gharahpetian </h5>
                                <h5 class="text-center"><span>on winning </span><b
                                        class="font-weight-bold">{{ $product->name }}</b></h5>
