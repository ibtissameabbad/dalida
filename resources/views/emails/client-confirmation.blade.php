                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                                                ...
                                                                <p
                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, \'helvetica neue\', helvetica, arial, sans-serif;line-height:27px;color:#666666;">
                                                                    Nous vous remercions d'avoir passé votre
                                                                    commande sur Dalida. Nous confirmons votre
                                                                    commande N°{{ $details['orderNumber'] }}
                                                                    passée
                                                                    le {{ date('d-m-Y') }} sur
                                                                    www.dalida.beauty.
                                                                </p>
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                ...
                                                                <p
                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, \'helvetica neue\', helvetica, arial, sans-serif;line-height:27px;color:#666666;">
                                                                    <strong>Informations de la commande</strong><br>

                                                                    Numéro de commande :
                                                                    {{ $details['orderNumber'] }} <br>
                                                                    Date : {{ date('d-m-Y') }}<br>
                                                                    Produit :<br>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    @if (count($details['categories']) > 0)
                                                                        <ul>
                                                                            @foreach ($details['categories'] as $product)
                                                                                <li>{{ $product['name'] }}</li>
                                                                            @endforeach
                                                                        </ul>
                                                                    @endif
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, \'helvetica neue\', helvetica, arial, sans-serif;line-height:27px;color:#666666;">
                                                                    Sous-Total :
                                                                    {{ currencySign($details['currency']) }}
                                                                    {{ $details['total'] }}<br>
                                                                    {{-- Expédition : .....<br> --}}
                                                                    Moyen de paiement : Paiement à la livraison<br>
                                                                    Total :
                                                                    {{ currencySign($details['currency']) }}
                                                                    {{ $details['total'] }}<br>
                                                                </p>
